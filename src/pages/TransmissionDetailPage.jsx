...
import EmbedRenderer from '../components/Embed/EmbedRenderer';
...
export default function TransmissionDetailPage({ reduceMotion }) {
  ...
  const heroEmbed = post.video ? { kind: 'youtube', url: post.video, title: 'Video transmission' } : post.audio ? { kind: 'audio', url: post.audio, title: 'Audio transmission' } : null;
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 lg:grid-cols-[1fr_240px]">
          <Card className="p-8">
            ...
            <article className="prose prose-invert mt-6 max-w-none text-slate-100 [&>h2]:mt-8 [&>h2]:text-2xl [&>h3]:mt-6 [&>h3]:text-xl">
